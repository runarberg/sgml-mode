	...
	("submit") ("reset"))
      ...
      ("meta" t ("charset" "utf-8") ("content")
       ("http-equiv" ("content-language") ("content-type") ("default-style")
        ("refresh") ("Allow") ("Content-Encoding") ("Content-Length")
        ("Date") ("Expires") ("Last-Modified") ("Location") ("Set-Cookeie"))
       ("name" ("application-name") ("author") ("description")
        ("generator") ("keywords")))
...
(defvar html-tag-help
  `(,@sgml-tag-help
    ...
    ("math" . "Math formula")
    ("menu" . "Menu list for interaction")
